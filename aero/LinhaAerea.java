...
public class LinhaAerea {
	...
	public static void main(String[] args) {
		...
		CompanhiaAerea ca1 = new CompanhiaAerea("0001","Amarelo");
		CompanhiaAerea ca2 = new CompanhiaAerea("0002","Cobrin");
		CompanhiaAerea ca3 = new CompanhiaAerea("0003","Falta");
		CompanhiaAerea ca4 = new CompanhiaAerea("0004","Pegar");
